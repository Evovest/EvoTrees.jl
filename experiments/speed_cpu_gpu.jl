...
# Tree GPU
###########################
δ, hist, K, edges, X_bin, splits = cache_g.δ, cache_g.hist, cache_g.K, cache_g.edges, cache_g.X_bin, cache_g.splits;
T = Float32
S = UInt32
active_id = ones(S, 1)
leaf_count = one(S)
...
EvoTrees.find_split_gpu_v2!(hist[j], edges, params_g);
